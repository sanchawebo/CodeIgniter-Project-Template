...
<?php $this->section('title') ?><?= lang('Auth.requestAccess.pageTitle') ?> <?php $this->endSection() ?>
...
<div class="box-w-600 mx-auto max-vh-100 p-5 overflow-y-auto -primary">
    ...
    <h1 class="text-center -size-2xl"><?= lang('Auth.requestAccess.title') ?></h1>
    <div class="o-form m-0">
        ...
        <form action="<?= url_to('request-access') ?>" method="post">
            ...
            <p class="text-center"><?= lang('Auth.requestAccess.text') ?></p>
            <!-- Email -->
            <div class="m-form-field">
                <div class="a-text-field">
                    <label for="email"><?= lang('Auth.requestAccess.email') ?> *</label>
            ...
            <div class="m-form-field">
                <div class="a-text-field">
                    <label for="bosch-email"><?= lang('Auth.requestAccess.boschEmail') ?> *</label>
            ...
            <button type="submit" class="a-button a-button--primary -without-icon w-100 mb-0">
                <span class="a-button__label"><?= lang('Auth.requestAccess.requestBtn') ?></span>
            </button>
