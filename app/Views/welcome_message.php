...
<section>
    ...
    <div class="px-4 bg-dark-subtle">
        <ul class="nav align-items-center">
            <li class="nav-item">
                <a class="nav-link link-light" href="https://codeigniter.com" target="_blank">
            ...
            <li class="nav-item"><a class="nav-link link-light" href="https://codeigniter.com/user_guide/" target="_blank">CI Docs</a>
            </li>
            <li class="nav-item"><a class="nav-link link-light" href="https://forum.codeigniter.com/" target="_blank">CI Community</a></li>
            <li class="nav-item"><a class="nav-link link-light"
                    href="https://codeigniter.com/contribute" target="_blank">Contribute to CI</a>
            </li>
        </ul>
    </div>
