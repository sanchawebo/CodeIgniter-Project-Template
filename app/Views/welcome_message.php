...
<?= ucfirst('Welcome to CodeIgniter Project Template!') . ' | ' . SITE_NAME ?>
<?php $this->endSection() ?>
...
<header>
    ...
    <div class="px-4 text-bg-dark">
        <ul class="nav align-items-center">
            <li class="nav-item">
                <a class="nav-link" href="https://codeigniter.com" target="_blank">
            ...
            <li class="nav-item"><a class="nav-link" href="https://codeigniter.com/user_guide/" target="_blank">Docs</a>
            </li>
            <li class="nav-item"><a class="nav-link" href="https://forum.codeigniter.com/" target="_blank">Community</a></li>
